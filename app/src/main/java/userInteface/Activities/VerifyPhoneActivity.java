...
public class VerifyPhoneActivity extends AppCompatActivity {
    ...
    private TextView password_screen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.login_with_password).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               Intent intent = new Intent(VerifyPhoneActivity.this,LoginWithPasswordActivity.class);
